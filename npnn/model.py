...
class Sequential:
    ...
    def forward(self, X, train=True):
        ...
        for idx, module in enumerate(self.modules):
            current_output = module.forward(current_output, train=train)
        predictions = self.loss.forward(current_output)
        return predictions
    ...
    def train(self, dataset):
        ...
        for X, y in tqdm(dataset, desc="Training Loop"):
            ...
            total_loss += loss
            total_accuracy += categorical_accuracy(out, y)

        mean_train_loss = total_loss / total_batches
        mean_train_accuracy = total_accuracy / total_batches
    ...
    def test(self, dataset):
        ...
        mean_test_loss = total_loss / total_batches
        mean_test_accuracy = total_accuracy / total_batches
